...
All the environments are registered in the `g1_wuji_doorman` extension. They start
...
import g1_wuji_doorman.tasks  # noqa: F401


def main():
    """Print all environments registered in `g1_wuji_doorman` extension."""
